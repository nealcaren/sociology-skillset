...
Append a `## Phase 0: Research Design` section to `memos/analysis-memo.md` (create the file if it does not exist) containing:
...
5. Confirmation that Phase 0 section was appended to `memos/analysis-memo.md`
