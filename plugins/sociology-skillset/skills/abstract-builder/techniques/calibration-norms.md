...
### Essential Moves (include in every abstract)

| Move | Frequency | Notes |
|------|-----------|-------|
| STUDY-FOCUS | 90% | What study examines |
| DATA-DESCRIBE | 87% | Interview sample |
| FINDINGS | 95% | 2-3 sentences typically |
| CLOSING | 100% | Contribution or implications |

### Optional Moves

| Move | Frequency | Notes |
|------|-----------|-------|
| GAP | ~40% | Common in Research-Report, Stakes-Driven |
| PRIOR-RESEARCH | ~30% | If not opening move |
| ARGUMENT | ~11% | Strong theoretical contribution |
